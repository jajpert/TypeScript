...
-Os módulos são a forma que temos para importa código
em arquivos
-Podemos exportar código com export default
-E importar com import
-Criaremos os arquivos com .ts, mas importaremos como .js
-Isso nos dá mais fexibilidade, podendo separar as responsabilidades 
em arquivos
...
/*
Importando arquivos
-Para começar vamos criar um arquivo simples e importar 
seu conteúdo
-Basta criar um arquivo .ts, desenvolver o código e exportar
-Depois no arquivo principal vamos importar o arquivo anterior, 
com a extensão .js
*/
...
-Podendo tornar este novo nome, uma forma simples de chamar o recurso
*/
...
-E no arquivo que os recebe, utilizamos desestructuring
